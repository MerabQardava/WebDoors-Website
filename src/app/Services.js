        ...
        <>
            ...
            <section>
                <div id="services_container">
                    <div id="row1">
                        <div id="cube1">
                            <svg id="brain" xmlns="http://www.w3.org/2000/svg" width="228" height="227"
                                 fill="none">
                                ...
                                <path
                                    ...
                                    fill="black"/>
                                <defs>
                                    <filter id="filter0_d_2897_164" x="0.978516" y="0" width="226.723" height="226.723"
                                        ...
                                        <feBlend mode="normal" in2="BackgroundImageFix"
                                                 result="effect1_dropShadow_2897_164"/>
                                        <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_2897_164"
                                                 result="shape"/>
                                    </filter>
                                </defs>
                            </svg>
                            <div id="analysis">
                                <h2><span style={{color: "#2596be"}}>01. </span>Analysis</h2>
                                <p>We work with our clients to gather the requirements, use cases, process
                                    specifications
                                    and conduct in-depth research on demographics,
                                    behavior patterns, and target audiences to refine your idea and create a strong app
                                    foundation</p>
